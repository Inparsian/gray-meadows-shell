// This code was autogenerated with `dbus-codegen-rust --crossroads -d org.freedesktop.Notifications -p /org/freedesktop/Notifications`, see https://github.com/diwic/dbus-rs
