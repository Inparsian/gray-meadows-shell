...
where T: OrgFreedesktopNetworkManager + Send + 'static
{
    cr.register("org.freedesktop.NetworkManager", |b| {
        ...
        b.property::<bool, _>("WirelessEnabled")
            ...
            .set(|_, t: &mut T, value| t.set_wireless_enabled(value).map(|()| None));
        ...
        b.property::<bool, _>("WwanEnabled")
            ...
            .set(|_, t: &mut T, value| t.set_wwan_enabled(value).map(|()| None));
        ...
        b.property::<bool, _>("WimaxEnabled")
            ...
            .set(|_, t: &mut T, value| t.set_wimax_enabled(value).map(|()| None))
        ...
        b.property::<bool, _>("ConnectivityCheckEnabled")
            ...
            .set(|_, t: &mut T, value| t.set_connectivity_check_enabled(value).map(|()| None));
        ...
        b.property::<arg::PropMap, _>("GlobalDnsConfiguration")
            ...
            .set(|_, t: &mut T, value| t.set_global_dns_configuration(value).map(|()| None));
    })
}
