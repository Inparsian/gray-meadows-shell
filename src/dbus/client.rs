// Everything here is boilerplate commonly generated by dbus-codegen, there are to be removed from proxy files
// generated by dbus-codegen and used here instead if needed.
